...
export class Scripts {
    ...
    async addJob(client, job, opts, jobId, parentOpts = {}) {
        ...
        const parent = job.parent
            ? Object.assign(Object.assign({}, job.parent), { fpof: opts.fpof, rdof: opts.rdof, idof: opts.idof, cpof: opts.cpof }) : null;
        const args = [
            queueKeys[''],
    ...
    removeArgs(jobId, removeChildren) {
        const keys = [jobId, 'meta', 'repeat'].map(name => this.queue.toKey(name));
